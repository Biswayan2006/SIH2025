    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        <div
          ...
          } backdrop-blur-lg shadow-2xl rounded-xl p-8 border ${
        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={isLoading}
              className={`w-full flex justify-center items-center py-3 px-4 mt-4 border rounded-lg shadow-sm text-sm font-medium ${
                darkMode
